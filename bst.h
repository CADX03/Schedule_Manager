...
template <class Comparable> class BSTItrInReverse;
...
class BinaryNode {
    ...
    friend class BSTItrInReverse<Comparable>;
...
//InorderReverse iterator (implemented by students)
template <class Comparable>
class BSTItrInReverse {
    stack<BinaryNode<Comparable> *> itrStack;
    void slideRight(BinaryNode<Comparable> *n);
public:
    BSTItrInReverse(const BST<Comparable>& bt);
    void advance();
    const Comparable& retrieve() const { return itrStack.top()->element; }
    bool isAtEnd() const { return itrStack.empty(); }
};
...
template <class Comparable>
BSTItrInReverse<Comparable>::BSTItrInReverse (const BST<Comparable>& bt) {
    if (!bt.isEmpty())
        slideRight(bt.root);
}

template <class Comparable>
void BSTItrInReverse<Comparable>::slideRight(BinaryNode<Comparable>* n) {
    while (n) {
        itrStack.push(n);
        n = n->right;
    }
...
template <class Comparable>
void BSTItrInReverse<Comparable>::advance() {
    BinaryNode<Comparable> * actual = itrStack.top();
    itrStack.pop();
    BinaryNode<Comparable> * next = actual->left;
    if (next)
